classdef UI < handle
    ...
    methods
        ...
        function ui = UI(path, name, pos)
            ...
            uimenu(ui.h.helpmenu, 'label', ['Version: ' num2str(ui.version)]);
...
%                 end
    ...
    methods (Access = private)
        ...
        function check_version(ui)
            if isdeployed()
                try
                    newestversion = str2double(urlread('http://www.daten.tk/webhook/tags.php?owner=sebastian.pfitzner&project=sisa-scan-auswertung'));
